...
import { Mountain, Hexagon, Zap, Rocket, Bot, Pickaxe, Shield, Plane, Target, Home, Factory, Wheat, Sun, Warehouse } from "lucide-react";
    ...
    <div className="absolute inset-0 flex items-center justify-center pointer-events-none z-10">
      <div className="relative">
        ...
        <div className={cn(
          ...
          building.type === "city" && "bg-amber-400",
          building.type === "farm" && "bg-green-400",
          building.type === "mine" && "bg-stone-400",
          building.type === "factory" && "bg-zinc-400",
          building.type === "barracks" && "bg-red-400",
          building.type === "solar_array" && "bg-blue-400",
          building.type === "skyport" && "bg-cyan-400",
          building.type === "silo" && "bg-purple-400",
          building.type === "bunker" && "bg-stone-500"
        )} />
  ...
  return (
    <div className="absolute z-20 flex flex-col items-center justify-center w-full h-full pointer-events-none">
      ...
      <div className="absolute bottom-1 w-8 h-1 bg-black/80 rounded-full overflow-hidden border border-white/10 mt-1">
        <div 
          className={cn("h-full transition-all duration-300", unit.hp > unit.maxMoves * 2 ? "bg-emerald-500" : "bg-red-500")} 
          style={{ width: `${Math.min((unit.hp / (unit.maxMoves * 5)) * 100, 100)}%` }} 
        />
      </div>
